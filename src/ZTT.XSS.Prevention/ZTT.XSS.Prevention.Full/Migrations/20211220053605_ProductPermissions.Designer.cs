...
namespace ZTT.XSS.Prevention.Full.Migrations
{
    ...
    [Migration("20211220053605_ProductPermissions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZTT.XSS.Prevention.Full.DataModels.DbImpliedPermission", b =>
                {
            ...
            modelBuilder.Entity("ZTT.XSS.Prevention.Full.DataModels.DbPermission", b =>
                {
                    b.Property<string>("PermissionCode")
                        .HasColumnType("nvarchar(40)")
                        .HasMaxLength(40);
            ...
            modelBuilder.Entity("ZTT.XSS.Prevention.Full.DataModels.DbProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ZTT.XSS.Prevention.Full.DataModels.DbUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZTT.XSS.Prevention.Full.DataModels.DbUserPermit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZTT.XSS.Prevention.Full.DataModels.DbUserPermitGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZTT.XSS.Prevention.Full.DataModels.DbUserSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ZTT.XSS.Prevention.Full.DataModels.DbImpliedPermission", b =>
                {
                    b.HasOne("ZTT.XSS.Prevention.Full.DataModels.DbPermission", "Implied")
                        .WithMany("IAmImplied")
                        .HasForeignKey("ImpliedPermissionCode")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("ZTT.XSS.Prevention.Full.DataModels.DbPermission", "Permission")
                        .WithMany("MyImplied")
            ...
            modelBuilder.Entity("ZTT.XSS.Prevention.Full.DataModels.DbProduct", b =>
                {
                    b.HasOne("ZTT.XSS.Prevention.Full.DataModels.DbUser", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("ZTT.XSS.Prevention.Full.DataModels.DbUser", b =>
                {
                    b.HasOne("ZTT.XSS.Prevention.Full.DataModels.DbUser", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("ZTT.XSS.Prevention.Full.DataModels.DbUserPermit", b =>
                {
                    ...
                    b.HasOne("ZTT.XSS.Prevention.Full.DataModels.DbUserPermitGroup", "UserPermitGroup")
                        .WithMany("Permits")
            ...
            modelBuilder.Entity("ZTT.XSS.Prevention.Full.DataModels.DbUserPermitGroup", b =>
                {
                    b.HasOne("ZTT.XSS.Prevention.Full.DataModels.DbUser", "User")
